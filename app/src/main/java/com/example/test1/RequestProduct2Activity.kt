...
class RequestProduct2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_request_product2)
        ...
        btOk.setOnClickListener {
            ...
            client.addNewPackStorehouse(listProduct)
        }
    ...
    private fun fillList(): List<Product> {
        val client = AirTableClient()
        return client.getProductsFromStorehouse()
    }
