...
class RequestProduct3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_request_product3)
        ...
        btOk.setOnClickListener {
            ...
            client.addNewPackDetergents(listProduct)
        }
    ...
    private fun fillList(): List<Product> {
        val client = AirTableClient()
        return client.getProductsFromDetergents()
    }
